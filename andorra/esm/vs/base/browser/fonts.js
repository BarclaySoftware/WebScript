 ...
 */
export const DEFAULT_FONT_FAMILY = isWindows ? '"andorraSans", "Segoe WPC", "Segoe UI", sans-serif' : isMacintosh ? '"andorraSans", -apple-system, BlinkMacSystemFont, sans-serif' : 'system-ui, "Ubuntu", "Droid Sans", sans-serif';
